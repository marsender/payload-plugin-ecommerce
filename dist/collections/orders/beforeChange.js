 ...
 */ export const beforeChangeOrder = ({ currenciesConfig, productsSlug, variantsSlug })=>async ({ data, req })=>{
        ...
        for (const item of data.items){
            ...
            if (typeof price !== 'number') {
                req.payload.logger.warn(`[order] No ${priceField} on ${source.collection} ${source.id}: amount left unset`);
                return data;
            }
